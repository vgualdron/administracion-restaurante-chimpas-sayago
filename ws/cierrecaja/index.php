    ...
    if (isset($_GET['fecha']) && isset($_GET['ventas'])) {
        ...
        foreach($row as $registro){
          ...
          if ($count2 > 0) {
            ...
            foreach($row2 as $registro2){
                ...
                if ($registro2['pedi_tipopago'] == 'EFECTIVO') {
                  $totalEfectivo += $registro2['total'];
                } else {
                  $totalTarjeta += $registro2['total'];
                }
      ...
      if ($count > 0) {
        ...
        foreach ($row as $registro) {
          ...
          if ($registro['pedi_tipopago'] == 'EFECTIVO') {
            $totalEfectivo += $registro['prod_precio'] * $registro['prod_cantidad'];
          } else {
            $totalTarjeta += $registro['prod_precio'] * $registro['prod_cantidad'];
          }
